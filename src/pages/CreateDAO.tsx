        ...
        return (
          <div className="space-y-8">
            ...
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-blue-300 mb-3">Governance Members</h3>
              <p className="text-blue-200 text-sm mb-4">
                Your DAO will be governed by token holders. Members can create proposals and vote on important decisions 
                affecting the organization's direction, treasury spending, and operational parameters.
              </p>
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  <h4 className="text-blue-300 font-medium mb-2">Who can participate:</h4>
                  <ul className="text-blue-200 space-y-1">
                    <li>• Token holders with voting power</li>
                    <li>• Delegated representatives</li>
                    <li>• Active community members</li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-blue-300 font-medium mb-2">Governance activities:</h4>
                  <ul className="text-blue-200 space-y-1">
                    <li>• Create and vote on proposals</li>
                    <li>• Manage treasury funds</li>
                    <li>• Update DAO parameters</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-purple-300 mb-3">Governance Token Contract</h3>
              <p className="text-purple-200 text-sm mb-4">
                Your governance token will be deployed as an ERC-20 contract with built-in voting capabilities. 
                This token represents voting power and membership in your DAO.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-white/5">
                  <h4 className="text-white font-medium mb-2">Token Features</h4>
                  <ul className="text-gray-300 text-sm space-y-1">
                    <li>• ERC-20 compatible</li>
                    <li>• Built-in voting power</li>
            ...
            {/* Voting Platform Setup */}
            <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-green-300 mb-3">Set Up Voting Page (Snapshot)</h3>
              <p className="text-green-200 text-sm mb-4">
                After deployment, you can create a Snapshot space for off-chain voting. This provides a user-friendly 
                interface for proposal creation and voting without gas costs.
              </p>
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-white/5">
                  <h4 className="text-white font-medium mb-2">Post-Deployment Steps:</h4>
                  <ol className="text-gray-300 text-sm space-y-1">
                    <li>1. Visit <a href="https://snapshot.org" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300">snapshot.org</a> and create a space</li>
                    <li>2. Configure your token contract address</li>
                    <li>3. Set up voting strategies and parameters</li>
                    <li>4. Customize your space branding and settings</li>
                  </ol>
                </div>
                <div className="p-4 rounded-lg bg-white/5">
                  <h4 className="text-white font-medium mb-2">Benefits of Snapshot:</h4>
                  <ul className="text-gray-300 text-sm space-y-1">
                    <li>• Gas-free voting for members</li>
                    <li>• Rich proposal formatting</li>
                    <li>• Multiple voting strategies</li>
            ...
            <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-orange-300 mb-3">DAO Profile Administrator</h3>
              <p className="text-orange-200 text-sm mb-4">
                After deployment, you can register your DAO on plsdao.xyz to create a public profile 
                and make it discoverable by the community.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-white/5">
                  <h4 className="text-white font-medium mb-2">Profile Features:</h4>
                  <ul className="text-gray-300 text-sm space-y-1">
                    <li>• Public DAO directory listing</li>
                    <li>• Custom branding and description</li>
                ...
                <div className="p-4 rounded-lg bg-white/5">
                  ...
                  <ol className="text-gray-300 text-sm space-y-1">
                    <li>1. Visit plsdao.xyz after deployment</li>
                    <li>2. Connect your wallet as DAO admin</li>
                    <li>3. Submit DAO information and branding</li>
                    <li>4. Verify ownership of the DAO contract</li>
                  </ol>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-white">Governance Parameters</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">
