...
const CreateDAO: React.FC = () => {
  ...
  const steps = [
    ...
    { number: 4, title: 'Governance', description: 'Set voting and execution parameters' },
    { number: 5, title: 'Calendar', description: 'Set up DAO activity tracking' }
  ];
      ...
      case 3:
        return (
          <div className="space-y-8">
            ...
            {/* Treasury Information Cards */}
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 rounded-xl bg-blue-500/10 border border-blue-500/20">
                <div className="flex items-start space-x-3">
                  <AlertCircle className="h-5 w-5 text-blue-400 mt-0.5 flex-shrink-0" />
                  <div>
                    <h4 className="text-blue-300 font-medium mb-2">Treasury Management</h4>
              ...
              <div className="p-6 rounded-xl bg-green-500/10 border border-green-500/20">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="text-green-300 font-medium mb-2">Security Features</h4>
                    <p className="text-green-200 text-sm">
                      Multi-signature protection and governance approval required for all 
                      treasury operations to ensure community oversight and security.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="p-6 rounded-xl bg-white/5 border border-white/10">
              <h4 className="text-white font-medium mb-4">Treasury Features</h4>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                    <span className="text-gray-300 text-sm">Multi-signature wallet support</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                    <span className="text-gray-300 text-sm">Governance-controlled spending</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                    <span className="text-gray-300 text-sm">Transparent fund tracking</span>
                  </div>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                    <span className="text-gray-300 text-sm">Automated proposal execution</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                    <span className="text-gray-300 text-sm">Asset diversification support</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                    <span className="text-gray-300 text-sm">Emergency pause functionality</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20">
              ...
              <p className="text-blue-200 mt-4">
                Currently, we aggregate <span className="font-semibold text-blue-100">DAO Google Calendar schedules</span>, 
                <span className="font-semibold text-blue-100"> proposal alerts</span>, and 
                <span className="font-semibold text-blue-100"> Twitter Space events</span>. The latter two 
                are automated, and for Google Calendar, share the public link below for integration.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-pink-400">(You need to set the calendar permissions to public.)</span>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-6 rounded-xl bg-white/5 border border-white/10 text-center">
                ...
                <h4 className="text-white font-medium mb-2">Google Calendar</h4>
                <p className="text-gray-300 text-sm">Sync your DAO events and meetings</p>
              </div>
              ...
              <div className="p-6 rounded-xl bg-white/5 border border-white/10 text-center">
                ...
                <h4 className="text-white font-medium mb-2">Proposal Alerts</h4>
                <p className="text-gray-300 text-sm">Automated notifications for voting deadlines</p>
              </div>
              ...
              <div className="p-6 rounded-xl bg-white/5 border border-white/10 text-center">
                ...
                <h4 className="text-white font-medium mb-2">Twitter Spaces</h4>
                <p className="text-gray-300 text-sm">Community discussions and AMAs</p>
              </div>
            </div>
